...
tags: []
doc_version: 2
doc_updated_at: "2026-01-13T13:02:52+00:00"
...
Add agentctl role <ROLE> to print a single role block from the agentctl.md role guide.
...
Role blocks will be parsed from the Role/phase command guide section.
