...
PLANNER: create task (auto ID) | `python .codex-swarm/agentctl.py task new --title "..." --description "..." --priority med --owner CODER --tag <tag>`
...
- After plan approval (unless the user opts out): `python .codex-swarm/agentctl.py task new --title "..." --description "..." --priority med --owner ORCHESTRATOR --depends-on "[]" --tag <tag>`
...
- Create tasks: `python .codex-swarm/agentctl.py task new --title "..." --description "..." --priority med --owner <ROLE> --depends-on "[]" --tag <tag>` (tags are required; use `task add` only for imported IDs)
...
python .codex-swarm/agentctl.py task new --title "..." --description "..." --priority med --owner CODER --tag <tag>
...
- Create new tasks via `python .codex-swarm/agentctl.py task new ...` so IDs are generated by agentctl; tags are required. Reserve `task add` for pre-existing IDs (imports/sync).
