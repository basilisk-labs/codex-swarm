...
- Auto-refresh `.codex-swarm/workspace/T-###/pr/diffstat.txt` and the README auto-summary during `agentctl integrate` so reviewers don’t need to run `pr update` manually.
...
- `scripts/agentctl.py`:
  - After merge, regenerate `.codex-swarm/workspace/T-###/pr/diffstat.txt`.
  - After merge, update `.codex-swarm/workspace/T-###/README.md` auto-summary block (between `<!-- BEGIN AUTO SUMMARY -->
- (no file changes)
...
- `.codex-swarm/workspace/T-080/README.md`
- `.codex-swarm/workspace/T-080/pr/diffstat.txt`
- `.codex-swarm/workspace/T-080/pr/meta.json`
- `.codex-swarm/workspace/T-080/pr/review.md`
- `.codex-swarm/workspace/T-080/pr/verify.log`
- `scripts/agentctl.py`
<!-- END AUTO SUMMARY -->
