...
- Add `agentctl pr note` to append correctly formatted handoff notes under `## Handoff Notes` in `.codex-swarm/workspace/T-###/pr/review.md`.
...
- Manual smoke: `python scripts/agentctl.py pr note T-069 --author CODER --body \"...\"` and confirm `.codex-swarm/workspace/T-069/pr/review.md` updates.
...
- `scripts/agentctl.py`:
  - Add `pr note` subcommand:
    ...
    - Appends a bullet under `## Handoff Notes` in `.codex-swarm/workspace/T-###/pr/review.md` as `- ROLE: TEXT`.
...
- Docs:
  - Update `.codex-swarm/agentctl.md` (and optionally `.codex-swarm/workspace/README.md`) to recommend `pr note` for handoff notes.
...
- `python scripts/agentctl.py task lint`
- Manual smoke:
  - Create/open a PR artifact and run `python scripts/agentctl.py pr note T-### --author CODER --body \"...\"`, then confirm `.codex-swarm/workspace/T-###/pr/review.md` is updated correctly.
