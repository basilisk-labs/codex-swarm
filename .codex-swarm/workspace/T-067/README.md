...
- `AGENTS.md`
- `README.md`
- `.codex-swarm/workspace/T-064/README.md`
- `.codex-swarm/workspace/T-067/README.md`
- `.codex-swarm/workspace/prs/README.md` (legacy)
- `.codex-swarm/workspace/T-067/pr/description.md`
- `.codex-swarm/workspace/T-067/pr/diffstat.txt`
- `.codex-swarm/workspace/T-067/pr/meta.json`
- `.codex-swarm/workspace/T-067/pr/review.md`
- `.codex-swarm/workspace/T-067/pr/verify.log`
- `scripts/agentctl.py`
<!-- END AUTO SUMMARY -->
...
- Bring `python scripts/agentctl.py` in line with the stricter `branch_pr` workflow spec:
  ...
  - PR artifacts under `.codex-swarm/workspace/T-###/pr/` with strict validation
...
- Worktrees are rooted at `.codex-swarm/worktrees/`, and PR artifacts are tracked under `.codex-swarm/workspace/T-###/pr/`.
- `tasks.json` updates for closure are now gated to `main`, and handoff notes are captured in `.codex-swarm/workspace/T-###/pr/review.md` and appended at `finish`.
