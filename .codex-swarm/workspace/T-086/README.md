...
- `GUIDELINE.md`
- `README.md`
- `.codex-swarm/workspace/T-086/README.md`
- `.codex-swarm/workspace/T-086/pr/diffstat.txt`
- `.codex-swarm/workspace/T-086/pr/meta.json`
- `.codex-swarm/workspace/T-086/pr/review.md`
- `.codex-swarm/workspace/T-086/pr/verify.log`
<!-- END AUTO SUMMARY -->
