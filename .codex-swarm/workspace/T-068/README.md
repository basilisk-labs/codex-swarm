...
- `python scripts/agentctl.py verify T-068 --log .codex-swarm/workspace/T-068/pr/verify.log`
- Re-run: `python scripts/agentctl.py verify T-068 --log .codex-swarm/workspace/T-068/pr/verify.log --skip-if-unchanged`
...
- `.codex-swarm/workspace/T-068/pr/description.md`
- `.codex-swarm/workspace/T-068/pr/diffstat.txt`
- `.codex-swarm/workspace/T-068/pr/meta.json`
- `.codex-swarm/workspace/T-068/pr/review.md`
- `.codex-swarm/workspace/T-068/pr/verify.log`
- `scripts/agentctl.py`
<!-- END AUTO SUMMARY -->
...
- `scripts/agentctl.py`:
  ...
  - Add `verify --skip-if-unchanged`:
    - If `--log` points under `.codex-swarm/workspace/T-###/pr/`, treat PR `meta.json:head_sha` as the “current SHA”.
  ...
  - After successful verify, persist `last_verified_sha` + `last_verified_at` in `.codex-swarm/workspace/T-###/pr/meta.json` when available.
- Docs:
...
- Manual smoke (branch_pr):
  - Run verify once: `python scripts/agentctl.py verify T-067 --log .codex-swarm/workspace/T-067/pr/verify.log`
