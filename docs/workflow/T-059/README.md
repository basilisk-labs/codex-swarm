...
- Add `task scaffold` (create `docs/workflow/T-###/README.md` from a template).
...
- Implemented new subcommands in `scripts/agentctl.py`:
  ...
  - `task scaffold` writes `docs/workflow/T-###/README.md` skeletons (uses existing task title by default).
